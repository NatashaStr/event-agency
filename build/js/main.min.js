...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _filter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filter.js */ "./js/modules/filter.js");
...
var initDropdown = function initDropdown() {
  ...
  document.querySelectorAll('.dropdown').forEach(function (dropdownWrapper) {
    var button = dropdownWrapper.querySelector('.dropdown__button');
    var list = dropdownWrapper.querySelector('.dropdown__list');
    var items = list.querySelectorAll('.dropdown__list-item');
    var input = dropdownWrapper.querySelector('.dropdown__input-hidden');
    ...
    items.forEach(function (listItem) {
      listItem.addEventListener('click', function (evt) {
        ...
        (0,_filter_js__WEBPACK_IMPORTED_MODULE_0__["default"])(evt.target.dataset.filter);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _initSwiper_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./initSwiper.js */ "./js/modules/initSwiper.js");

var initialList = document.querySelectorAll('[data-sex]');
var ulElem = document.querySelector('.events__list');
var filter = function filter(filterValue) {
  var filteredList = [];
  initialList.forEach(function (el) {
    var sex = el.dataset.sex;
    if (filterValue === sex) {
  ...
  _initSwiper_js__WEBPACK_IMPORTED_MODULE_0__["default"].update();
};
/* harmony default export */ __webpack_exports__["default"] = (filter);

/***/ }),

/***/ "./js/modules/initSwiper.js":
/*!**********************************!*\
  !*** ./js/modules/initSwiper.js ***!
  \**********************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var initSwiperEvents = new Swiper('.swiper', {
  navigation: {
...
/* harmony default export */ __webpack_exports__["default"] = (initSwiperEvents);
